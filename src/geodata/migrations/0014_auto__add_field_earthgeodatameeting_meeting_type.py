...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('geodata_earthgeodatameeting', 'meeting_type', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EarthGeoDataMeeting.meeting_type'
        db.delete_column('geodata_earthgeodatameeting', 'meeting_type')
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 14, 20, 11, 891768)'}),
