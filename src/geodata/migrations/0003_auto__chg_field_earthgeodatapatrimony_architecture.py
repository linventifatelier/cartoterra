...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EarthGeoDataPatrimony.architecture'
        db.alter_column('geodata_earthgeodatapatrimony', 'architecture_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geodata.EarthArchitecture'], null=True))


    def backwards(self, orm):
        
        # Changing field 'EarthGeoDataPatrimony.architecture'
        db.alter_column('geodata_earthgeodatapatrimony', 'architecture_id', self.gf('django.db.models.fields.related.ForeignKey')(default='toto', to=orm['geodata.EarthArchitecture']))
    ...
    models = {
        ...
        'geodata.earthgeodatapatrimony': {
            ...
            'architecture': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geodata.EarthArchitecture']", 'null': 'True', 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 17, 52, 57, 403614)'}),
