...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EarthGeoDataConstruction.inauguration_date'
        db.add_column('geodata_earthgeodataconstruction', 'inauguration_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EarthGeoDataConstruction.inauguration_date'
        db.delete_column('geodata_earthgeodataconstruction', 'inauguration_date')
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 16, 14, 56, 53, 301767)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 4, 16)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'credit_creator': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 4, 16)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
