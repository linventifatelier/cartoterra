...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EarthGeoDataMeeting.credit_creator'
        db.add_column('geodata_earthgeodatameeting', 'credit_creator', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'EarthGeoDataConstruction.credit_creator'
        db.add_column('geodata_earthgeodataconstruction', 'credit_creator', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'EarthGeoDataPatrimony.credit_creator'
        db.add_column('geodata_earthgeodatapatrimony', 'credit_creator', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EarthGeoDataMeeting.credit_creator'
        db.delete_column('geodata_earthgeodatameeting', 'credit_creator')

        # Deleting field 'EarthGeoDataConstruction.credit_creator'
        db.delete_column('geodata_earthgeodataconstruction', 'credit_creator')

        # Deleting field 'EarthGeoDataPatrimony.credit_creator'
        db.delete_column('geodata_earthgeodatapatrimony', 'credit_creator')
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 15, 24, 45, 453757)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 11)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'credit_creator': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 11)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
