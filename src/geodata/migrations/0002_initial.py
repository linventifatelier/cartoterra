...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('geodata_earthgeodatapatrimony', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 24, 17, 46, 24, 187057))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ...
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')()),
            ('architecture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geodata.EarthArchitecture'])),
    ...
    models = {
        ...
        'geodata.earthgeodatapatrimony': {
            ...
            'architecture': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geodata.EarthArchitecture']"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 17, 46, 24, 187057)'}),
