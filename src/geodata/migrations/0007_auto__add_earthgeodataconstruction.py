...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('geodata_earthgeodataconstruction', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 26, 17, 28, 11, 122237))),
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 17, 28, 11, 122237)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 26)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 26)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
