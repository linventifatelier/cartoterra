...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EarthTechnique.image'
        db.alter_column('geodata_earthtechnique', 'image', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 17, 18, 59, 906325)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 3)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 3)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'geodata.earthtechnique': {
            ...
            'image_display': ('geodata.image.AutoImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
