...
urlpatterns = patterns(
    ...
    url(r'^feeds/people/$', feeds.StakeholderFeed(), name="feed_people"),
    ...
    url(r'^profile/(?P<slug>[\w\._-]+)/creator/people/geojson/$',
        ...
        name="geojson_profile_creator_people"),
    ...
    url(r'^profile/(?P<slug>[\w\._-]+)/recommend/people/geojson/$',
        ...
        name="geojson_profile_recommend_people"),
)
