...
urlpatterns = [
    ...
    url(r'^group/(?P<pk>\d+)/$',
        ...
        name="group_detail"),
    url(r'^group/(?P<pk>\d+)/building/geojson/$',
        views.GeoJSONEarthGroupBuildingListView.as_view(),
        name="geojson_group_building"),
    url(r'^group/(?P<pk>\d+)/worksite/geojson/$',
        views.GeoJSONEarthGroupWorksiteListView.as_view(),
        name="geojson_group_worksite"),
    url(r'^group/(?P<pk>\d+)/event/geojson/$',
        views.GeoJSONEarthGroupEventListView.as_view(),
        name="geojson_group_event"),
