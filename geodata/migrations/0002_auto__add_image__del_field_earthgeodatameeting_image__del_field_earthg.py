...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EarthGeoDataMeeting.image'
        db.delete_column(u'geodata_earthgeodatameeting', 'image')

        # Deleting field 'EarthGeoDataActor.image'
        db.delete_column(u'geodata_earthgeodataactor', 'image')

        # Deleting field 'EarthGeoDataConstruction.image'
        db.delete_column(u'geodata_earthgeodataconstruction', 'image')

        # Deleting field 'EarthGeoDataPatrimony.image'
        db.delete_column(u'geodata_earthgeodatapatrimony', 'image')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EarthGeoDataMeeting.image'
        db.add_column(u'geodata_earthgeodatameeting', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EarthGeoDataActor.image'
        db.add_column(u'geodata_earthgeodataactor', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EarthGeoDataConstruction.image'
        db.add_column(u'geodata_earthgeodataconstruction', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EarthGeoDataPatrimony.image'
        db.add_column(u'geodata_earthgeodatapatrimony', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'geodata.earthgeodataactor': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
        ...
        u'geodata.earthgeodatameeting': {
            ...
            'actor': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['geodata.EarthGeoDataActor']", 'null': 'True', 'blank': 'True'}),
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'credit_creator': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'geodata.earthmeetingtypetranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'EarthMeetingTypeTranslation', 'db_table': "u'geodata_earthmeetingtype_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['geodata.EarthMeetingType']"}),
