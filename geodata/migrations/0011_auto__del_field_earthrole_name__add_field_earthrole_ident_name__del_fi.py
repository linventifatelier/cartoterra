...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EarthRole.name'
        db.delete_column('geodata_earthrole', 'name')

        # Adding field 'EarthRole.ident_name'
        db.add_column('geodata_earthrole', 'ident_name',
                      self.gf('django.db.models.fields.CharField')(default='architect', unique=True, max_length=255),
                      keep_default=False)

        # Deleting field 'EarthRoleTranslation.translated_name'
        db.delete_column('geodata_earthrole_translation', 'translated_name')

        # Adding field 'EarthRoleTranslation.name'
        db.add_column('geodata_earthrole_translation', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EarthRole.name'
        db.add_column('geodata_earthrole', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True),
                      keep_default=False)

        # Deleting field 'EarthRole.ident_name'
        db.delete_column('geodata_earthrole', 'ident_name')

        # Adding field 'EarthRoleTranslation.translated_name'
        db.add_column('geodata_earthrole_translation', 'translated_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'EarthRoleTranslation.name'
        db.delete_column('geodata_earthrole_translation', 'name')
    ...
    models = {
        ...
        'geodata.earthgeodataactor': {
            'Meta': {'ordering': "['name']", 'object_name': 'EarthGeoDataActor'},
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'credit_creator': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
