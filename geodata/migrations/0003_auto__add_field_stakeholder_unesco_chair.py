...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stakeholder.unesco_chair'
        db.add_column(u'geodata_stakeholder', 'unesco_chair',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stakeholder.unesco_chair'
        db.delete_column(u'geodata_stakeholder', 'unesco_chair')
