...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.number_of_stakeholders'
        db.add_column(u'geodata_event', 'number_of_stakeholders',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.number_of_stakeholders'
        db.delete_column(u'geodata_event', 'number_of_stakeholders')
