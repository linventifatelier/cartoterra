...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EarthGeoDataPatrimony.architects'
        db.add_column('geodata_earthgeodatapatrimony', 'architects',
    ...
    def backwards(self, orm):
        # Deleting field 'EarthGeoDataPatrimony.architects'
        db.delete_column('geodata_earthgeodatapatrimony', 'architects')
    ...
    models = {
        ...
        'geodata.earthgeodataconstruction': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 2, 0, 0)'}),
        ...
        'geodata.earthgeodatameeting': {
            ...
            'beginning_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 2, 0, 0)'}),
            'contact': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'credit_creator': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 2, 0, 0)'}),
            'geometry': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
