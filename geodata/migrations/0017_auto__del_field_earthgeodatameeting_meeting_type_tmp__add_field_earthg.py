...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EarthGeoDataMeeting.meeting_type_tmp'
        db.delete_column('geodata_earthgeodatameeting', 'meeting_type_tmp_id')

        # Adding field 'EarthGeoDataMeeting.meeting_type'
        db.add_column('geodata_earthgeodatameeting', 'meeting_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geodata.EarthMeetingType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EarthGeoDataMeeting.meeting_type_tmp'
        db.add_column('geodata_earthgeodatameeting', 'meeting_type_tmp',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geodata.EarthMeetingType'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EarthGeoDataMeeting.meeting_type'
        db.delete_column('geodata_earthgeodatameeting', 'meeting_type_id')
