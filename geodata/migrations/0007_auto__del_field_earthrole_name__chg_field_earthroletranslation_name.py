...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EarthRoleTranslation.name'
        db.alter_column('geodata_earthrole_translation', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EarthRoleTranslation.name'
        db.alter_column('geodata_earthrole_translation', 'name', self.gf('django.db.models.fields.TextField')())
